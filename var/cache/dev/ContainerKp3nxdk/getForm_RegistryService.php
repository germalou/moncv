...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CompetencesType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CompetencesType']) ? $this->services['AppBundle\Form\CompetencesType'] : $this->services['AppBundle\Form\CompetencesType'] = new \AppBundle\Form\CompetencesType()) && false ?: '_'};
}, 'AppBundle\\Form\\ExperiencesType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ExperiencesType']) ? $this->services['AppBundle\Form\ExperiencesType'] : $this->services['AppBundle\Form\ExperiencesType'] = new \AppBundle\Form\ExperiencesType()) && false ?: '_'};
}, 'AppBundle\\Form\\FormationsType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FormationsType']) ? $this->services['AppBundle\Form\FormationsType'] : $this->services['AppBundle\Form\FormationsType'] = new \AppBundle\Form\FormationsType()) && false ?: '_'};
}, 'AppBundle\\Form\\LoisirsType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LoisirsType']) ? $this->services['AppBundle\Form\LoisirsType'] : $this->services['AppBundle\Form\LoisirsType'] = new \AppBundle\Form\LoisirsType()) && false ?: '_'};
